...
Address.prototype.isWitnessPubkeyhash = function isWitnessPubkeyhash() {
  return (this.version === 0 || this.version === 9) && this.hash.length === 20;
};
...
Address.prototype.isWitnessScripthash = function isWitnessScripthash() {
  return (this.version === 0 || this.version === 9) && this.hash.length === 32;
};
...
Address.prototype.isCanonical = function isCanonical() {
  return this.version >= 0 && this.version <= 8;
};
...
Address.prototype.isExtension = function isExtension() {
  return this.version >= 9 && this.version <= 16;
};
