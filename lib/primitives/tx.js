...
/**
 * Calculate total sigops cost of exiting outputs.
 * @returns {Number} size
 */
...
TX.prototype.getChain = function getChain(view, flags) {
  var chain = -1;
  var i, input, coin;
...
TX.prototype.isResolution = function isResolution() {
  ...
  return this.outputs[0].script.isResolution();
};
