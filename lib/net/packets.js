...
function BlockPacket(block, extension) {
  if (!(this instanceof BlockPacket))
    return new BlockPacket(block, extension);
...
function TXPacket(tx, extension) {
  if (!(this instanceof TXPacket))
    return new TXPacket(tx, extension);
 ...
 * @constructor
 * @param {Block|null} block
 * @param {Boolean|null} extension
 * @property {Block} block
 * @property {Boolean} extension
 */

function CmpctBlockPacket(block, extension) {
  if (!(this instanceof CmpctBlockPacket))
    return new CmpctBlockPacket(block, extension);
...
function BlockTxnPacket(response, extension) {
  if (!(this instanceof BlockTxnPacket))
    return new BlockTxnPacket(response, extension);
