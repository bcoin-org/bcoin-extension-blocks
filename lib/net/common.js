...
/**
 * Minimum version for extension blocks + bip152.
 * @const {Number}
 * @default
 */

exports.COMPACT_EXTENSION_VERSION = 70016;
...
exports.services = {
  ...
  /**
   * Whether the peer supports extension blocks.
   */
...
/**
 * Max message size (~7mb with extblk, formerly 4mb)
 * @const {Number}
 * @default
 */

exports.MAX_MESSAGE = 7 * 1000 * 1000;
