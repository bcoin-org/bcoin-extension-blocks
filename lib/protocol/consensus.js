...
/**
 * Maximum extension block sigops (consensus).
 * @const {Number}
 * @default
 */

exports.MAX_EXTENSION_SIGOPS = 2000000 / 50;

/**
 * Maximum extension block sigops cost (consensus).
 * @const {Number}
 * @default
 */

exports.MAX_EXTENSION_SIGOPS_COST = 160000;
