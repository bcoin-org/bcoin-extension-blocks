...
/**
 * Consensus verify flags (used for extension block validation).
 * @const {VerifyFlags}
 * @default
 */

exports.flags.MANDATORY_EXTENSION_FLAGS = 0
...
/**
 * Standard verify extension flags (used for mempool validation).
 * @const {VerifyFlags}
 * @default
 */

exports.flags.STANDARD_EXTENSION_FLAGS = 0
  | exports.flags.MANDATORY_EXTENSION_FLAGS
