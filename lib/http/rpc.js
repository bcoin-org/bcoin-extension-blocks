...
RPC.prototype._createTemplate = co(function* _createTemplate(maxVersion, coinbase, rules) {
  ...
  var scale = attempt.extended ? 1 : consensus.WITNESS_SCALE_FACTOR;
  ...
  if (attempt.extended) {
    ...
    json.extsigoplimit = consensus.MAX_EXTENSION_SIGOPS_COST;
    json.sigoplimit = consensus.MAX_BLOCK_SIGOPS_COST;
  }
