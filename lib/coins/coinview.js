...
CoinView.prototype.addTX = function addTX(tx, height, extension) {
  var coins = Coins.fromTX(tx, height, extension);
...
CoinView.prototype.unspend = function unspend(input) {
  var coins = this.get(input.prevout.hash);
  var entry;
