...
CoinEntry.prototype.toCoin = function toCoin(coins, index) {
  ...
  coin.extended = this.extended;
  coin.resolution = coins.resolution;
...
CoinEntry.prototype.getSize = function getSize() {
  if (!this.raw)
    return 1 + compress.size(this.output);
