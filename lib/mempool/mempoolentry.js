...
MempoolEntry.prototype.fromTX = function fromTX(tx, view, height, chain) {
...
MempoolEntry.fromTX = function fromTX(tx, view, height, chain) {
  return new MempoolEntry().fromTX(tx, view, height, chain);
};
